...
DROP TABLES IF EXISTS `type_of_equipment`;
DROP TABLES IF EXISTS `equipment`;
DROP TABLES IF EXISTS `user`;
DROP TABLES IF EXISTS `equipment_has_user`;
DROP TABLES IF EXISTS `laser_cutter`;
DROP TABLES IF EXISTS `user_has_laser_cutter`;
DROP TABLES IF EXISTS `equipment_transfer`;
DROP TABLES IF EXISTS `equipment_has_equipment_transfer`;
DROP TABLES IF EXISTS `repairs_worker`;
DROP TABLES IF EXISTS `repair`;
DROP TABLES IF EXISTS `equipment_has_repairs`;
DROP TABLES IF EXISTS `laser_cutter_has_repair`;
